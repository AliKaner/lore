...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:static z-30 h-full w-56 bg-black/60 border-r border-white/10 flex flex-col transition-transform duration-300 md:translate-x-0 ${
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Mobile topbar */}
        <div className="md:hidden flex items-center gap-3 px-4 py-3 bg-black/40 border-b border-white/10">
          <button
          ...
          <span className="text-white font-title font-bold">
